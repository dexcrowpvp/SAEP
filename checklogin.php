...
if(isset($_POST['rut']) and isset($_POST['contrasena'])){
    ...
    $query = 'SELECT * FROM usuario WHERE rut= "'.$rut.'" and contrasena="'.$contrasena.'"';
...
if (isset($_SESSION['rut'])){
    ...
    echo 
        "<div class=margenlogin>
            <div>
                <h3><a href=alumnos.php>Colsultar datos de alumno</a><h3>
            </div>
        </div>";
    ...
    echo 
        "<div class=margenlogin>
            <div>
                <h3><a href=clase.php>Colsultar datos de la clase</a><h3>
            </div>
        </div>";
