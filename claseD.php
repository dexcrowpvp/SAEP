			...
			<div class="margenlogin">
				<div class="col-md-4 col-sm-12">
                    <div class="contact-form bottom">
                        ...
                        <form id="main-contact-form" name="contact-form" method="post" action="listadoclaseD.php">
                            <div class="form-group">
                                <input type="text" name="rut" class="form-control" required="rut" placeholder="Rut del maestro">
                            </div>                   
                            <div class="form-group">
